...
//right
			...
			class Single : Mode_SemiAuto
		{
			...
			{
				soundSetShot[] = {"Rook40_Shot_SoundSet","P07_Tail_SoundSet","P07_InteriorTail_SoundSet"};
			};
			class SilencedSound : BaseSoundModeType
			{
				SoundSetShot[] = {"Rook40_silencerShot_SoundSet","P07_silencerTail_SoundSet","P07_silencerInteriorTail_SoundSet"};
			};
...
class ADFRC_HP_MK3 : ADFRC_BHP_Base
	{
		author = "Brucey";
		ACE_barrelTwist = 254;
		...
		model = "ADF_Weapons\ADFRC_HPIII\adfrc_hp_MK3";
		descriptionShort = "FN Browning <br/> Hi-Power <br/>Caliber: 9MM";
		inertia = 0.85;
		scope=2;
		scopeWeapon=2;
		scopeArsenal = 2;
		...
		class Library
		{
			libTextDesc = "BHP MkIII";
		};
	};
};

class ADFRC_HPII : ADFRC_HP_MK3
	{
