class ADFRC_EXPS3 : ItemCore
	{
		...
		author=Brucey;
		picture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_ca.paa";
		uipicture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_ca.paa";
		model = "ADF_Weapons\adfrc_optics\EXPS3\ADFRC_EXPS3.p3d";
		scope =2;
...
class ADFRC_EXPS3_Down : ADFRC_EXPS3
	{
		...
		author=Brucey;
		picture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_Mag_ca.paa";
		uipicture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_Mag_ca.paa";
		model = "ADF_Weapons\adfrc_optics\EXPS3\ADFRC_EXPS3_Mag_Down.p3d";
		scope =2;
		descriptionShort = "EoTech EXPS3";
...
class ADFRC_EXPS3_Up : ADFRC_EXPS3
	{
		...
		picture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_Mag_ca.paa";
		uipicture="ADF_Weapons\adfrc_optics\EXPS3\UI\EXPS3_Mag_ca.paa";
		model = "ADF_Weapons\adfrc_optics\EXPS3\ADFRC_EXPS3_Mag_Up.p3d";
		scope =2;
		descriptionShort = "EoTech EXPS3";
