class CfgPatches
{
	class ADFRC_carlgustav
	{
		units[]={};
		weapons[]=
		{
			"ADFRC_carlgustav_m3",
			"ADFRC_carlgustav_m3_mrco"
		};
		magazines[]=
		{
		...
		ammo[]=
		{
			"ADFRC_Gustav_HEAT_JET",
			"ADFRC_RR_Ammo_Base",
			"ADFRC_Shell_84mm_adm_401",
			"ADFRC_Shell_84mm_asm_509",
			"ADFRC_Shell_84mm_he_441d",
			"ADFRC_Shell_84mm_heat_551c",
			"ADFRC_Shell_84mm_heat_751",
			"ADFRC_Shell_84mm_hedp_502",
			"ADFRC_Shell_84mm_illum_545c",
			"ADFRC_Shell_84mm_mt_756",
			"ADFRC_Shell_84mm_smk_469c"
		};
	};
};
class cfgAmmo
{
	...
	class BulletBase;
	class ADFRC_Gustav_HEAT_JET: BulletBase
	{
		author="$STR_ADFRC_AUTHOR";
		explosive=1;
		hit=950;
	...
	class ADFRC_Shell_84mm_adm_401: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_adm_401_fly";
		mass=40;
	};
	class ADFRC_Shell_84mm_asm_509: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_asm_509_fly";
		mass=55;
		hit=900;
		inndirectHit=200;
		indirectHitRange=10;
	...
	class ADFRC_Shell_84mm_he_441d: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_he_441d_fly";
		mass=40;
		hit=20;
		inndirectHit=50;
		indirectHitRange=20;
	...
	class ADFRC_Shell_84mm_heat_551c: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_heat_551c_fly";
		mass=45;
		AIS_Penetrator=1;
	...
	class ADFRC_Shell_84mm_heat_751: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_heat_751_fly";
		mass=65;
		hit=700;
		indirectHit=20;
		indirectHitRange=5;
		AIS_Penetrator=1;
		AIS_Penetrator_HEAT=1;
		AIS_Penetrator_Ammo="ADFRC_Gustav_HEAT_JET";
	};
	class ADFRC_Shell_84mm_hedp_502: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_hedp_502_fly";
		mass=40;
		AIS_Penetrator=1;
	...
	class ADFRC_Shell_84mm_illum_545c: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_illum_545c_fly";
		mass=30;
	};
	class ADFRC_Shell_84mm_mt_756: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_mt_756_fly";
		mass=40;
	};
	class ADFRC_Shell_84mm_smk_469c: ADFRC_RR_Ammo_Base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
		model="\adf_weapons\adfrc_carlgustav\ammo\84mm_smk_469c_fly";
		mass=35;
		hit=60;
		indirectHit=20;
		indirectHitRange=5;
...
class cfgMagazines
{
	...
	class ADFRC_magazine_84mm_base: CA_LauncherMagazine
	{
		scope=1;
		author="$STR_ADFRC_AUTHOR";
	...
	class ADFRC_magazine_84mm_asm_509: ADFRC_magazine_84mm_base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
	...
	class ADFRC_magazine_84mm_he_441d: ADFRC_magazine_84mm_base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
	...
	class ADFRC_magazine_84mm_heat_551c: ADFRC_magazine_84mm_base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
	...
	class ADFRC_magazine_84mm_heat_751: ADFRC_magazine_84mm_base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
	...
	class ADFRC_magazine_84mm_hedp_502: ADFRC_magazine_84mm_base
	{
		scope=2;
		author="$STR_ADFRC_AUTHOR";
...
class cfgWeapons
{
	...
	class ADFRC_carlgustav_m3: Launcher_Base_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"\adf_weapons\adfrc_carlgustav\anim\m3_carlgustav.rtm"
		};
		...
		reloadMagazineSound[]=
		{
			"\adf_weapons\adfrc_carlgustav\sound\carlgustav_reload.ogg",
			1,
			1,
			20
		};
		...
		class StandardSound: BaseSoundModeType
		{
			begin1[]=
			{
				"adf_weapons\adfrc_carlgustav\sound\carlgustav_shot.ogg",
				3.1622777,
				1,
				1400
			};
