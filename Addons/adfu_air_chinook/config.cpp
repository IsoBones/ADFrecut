class CfgPatches
{
	class ADFU_air_chinook
	{
		...
		weapons[]=
		{
			"ADFU_PHOENIX_CMFlareLauncher",
			"ADFU_air_chinook_M134",
			"ADFU_air_chinook_M134_2"
		};
		requiredVersion=1;
		requiredAddons[]=
		{
		...
		magazines[]=
		{
			"ADFU_air_chinook_4000Rnd_762x51",
			"ADFU_air_chinook_2000Rnd_762x51"
		};
		ammo[]=
		{
			"ADFU_air_chinook_762x51_Ball",
			"ADFU_air_chinook_762x51_3RndBurst"
		};
	};
};
...
class CfgVehicles
{
	...
	class ADFU_air_chinook_base: Helicopter_Base_H
	{
		scope=0;
		...
		class Damage
		{
			...
			mat[]=
			{
				"adfu_air_chinook\data\ch47_1.rvmat",
				"adfu_air_chinook\data\ch47_1_damage.rvmat",
				"adfu_air_chinook\data\ch47_1_destruct.rvmat",
				"adfu_air_chinook\data\ch47_2.rvmat",
				"adfu_air_chinook\data\ch47_2_damage.rvmat",
				"adfu_air_chinook\data\ch47_2_destruct.rvmat",
				"adfu_air_chinook\data\ch47_1_int.rvmat",
				"adfu_air_chinook\data\ch47_1_int.rvmat",
				"adfu_air_chinook\data\ch47_1_int_destruct.rvmat",
				"adfu_air_chinook\data\ch47_2_int.rvmat",
				"adfu_air_chinook\data\ch47_2_int.rvmat",
				"adfu_air_chinook\data\ch47_2_int_destruct.rvmat",
				"adfu_air_chinook\data\ch47_sklo_in.rvmat",
				"adfu_air_chinook\data\ch47_sklo_in_damage.rvmat",
				"adfu_air_chinook\data\ch47_sklo_in_damage.rvmat",
				"adfu_air_chinook\data\ch47_sklo.rvmat",
				"adfu_air_chinook\data\ch47_sklo_damage.rvmat",
				"adfu_air_chinook\data\ch47_sklo_damage.rvmat",
	...
	class ADFU_air_chinook: ADFU_air_chinook_base
	{
		scope=2;
		side=1;
		author="$STR_ADFU_AUTHOR";
		faction="ADFU";
		model="adfu_air_chinook\CH_47F";
		displayname="CH-47F Chinook";
		EditorPreview="adfu_air_chinook\data\adfu_air_chinook.jpg";
		accuracy=1000;
		hiddenSelections[]=
		{
			"Camo1",
		...
		{
			"adfu_air_chinook\data\ch47_ext_1_co.paa",
			"adfu_air_chinook\data\ch47_ext_2_co.paa",
			"adfu_air_chinook\data\ch47f_nalepky_ca.paa"
		};
		soundGetIn[]=
		{
			"adfu_air_chinook\data\sounds\getin",
			"db-10",
			1
		};
		soundGetOut[]=
		...
		soundEngineOnInt[]=
		{
			"adfu_air_chinook\data\sounds\uk_start_int_1",
			"db-20",
			0.89999998
		};
		soundEngineOnExt[]=
		{
			"adfu_air_chinook\data\sounds\uk_start_ext_1",
			"db-5",
			0.89999998,
			800
		};
		soundEngineOffInt[]=
		{
			"\adfu_air_chinook\data\sounds\uk_stop_int_1",
			"db-20",
			0.89999998
		};
		soundEngineOffExt[]=
		{
			"adfu_air_chinook\data\sounds\uk_stop_ext_2",
			"db-5",
			0.89999998,
			800
		};
		...
		{
			"adfu_air_chinook\data\sounds\missile",
			"db3",
			1
		};
		class Sounds
		{
			class Engine
			{
				sound[]=
				{
					"adfu_air_chinook\data\sounds\uk_engine_ext_3",
					"db10",
					0.80000001,
					1000
				};
			...
			class RotorLowOut
			{
				sound[]=
				{
					"\adfu_air_chinook\data\sounds\uk_rotor_4h_swist",
					"db10",
					1,
					1200
				};
			...
			class EngineIn
			{
				sound[]=
				{
					"\adfu_air_chinook\data\sounds\uk_engine_int_1",
					"db-5",
					0.80000001
				};
				frequency="rotorSpeed";
			...
			class RotorLowIn
			{
				sound[]=
				{
					"adfu_air_chinook\data\sounds\uk_rotor_4l_int",
					"db5",
					0.80000001
				};
				frequency="rotorSpeed";
			...
			class RotorHighIn
			{
				sound[]=
				{
					"adfu_air_chinook\data\sounds\uk_rotor_4h_int",
					"db5",
					0.80000001
				};
				frequency="rotorSpeed";
		...
		supplyRadius=5;
		maxSpeed=315;
		picture="\adfu_air_chinook\data\Picture_ch47f_CA.paa";
		icon="\adfu_air_chinook\data\Icon_ch47f_CA.paa";
		mapSize=24;
		crew="ADFU_helicopterPilot_amp";
		typicalCargo[]=
		{
		...
		class AnimationSources: AnimationSources
		{
			...
			{
				source="revolving";
				weapon="ADFU_air_chinook_M134";
			};
			class Gatling_2
			{
				source="revolving";
				weapon="ADFU_air_chinook_M134_2";
			};
			class Gatling_flash
			{
				source="ammorandom";
