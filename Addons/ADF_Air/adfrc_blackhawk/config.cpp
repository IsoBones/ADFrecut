class CfgPatches
{
	class ADFRC_blackhawk
	{
		...
		magazines[]=
		{
			"ADFRC_blackhawk_200Rnd_762x51_Tracer"
		};
	};
};
class CfgMovesBasic
...
class cfgWeapons
{
	class LMG_RCWS;
	class MGun;
	class ADFRC_blackhawk_MAG58: LMG_RCWS
	{
	...
	class ADFRC_blackhawk_MAG582: ADFRC_blackhawk_MAG58
	{
		scope=1;
		class GunParticles
		{
...
class cfgMagazines
{
	...
	class ADFRC_blackhawk_200Rnd_762x51_Tracer: 150Rnd_762x51_Box
	{
		scope=1;
		author="$STR_ADFRC_AUTHOR";
