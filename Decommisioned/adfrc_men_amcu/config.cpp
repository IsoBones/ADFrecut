class CfgPatches{
	class ADFRC_Units_AMCU{
		units[]={
			"ADFRC_AMCU_Soldier_F",
			"ADFRC_AMCU_Soldier_Grenadier",
			"ADFRC_AMCU_Soldier_LSW",
			"ADFRC_AMCU_Soldier_SectionLeader",
			"ADFRC_AMCU_Soldier_BrickLeader",
			"ADFRC_AMCU_Soldier_Marksman",
			"ADFRC_AMCU_Soldier_MATGunner",
			"ADFRC_AMCU_Soldier_CFA",
			"ADFRC_AMCU_Soldier_Engineer",
			"ADFRC_AMCU_Soldier_HeliPilot",
			"ADFRC_AMCU_Soldier_HeliCrew",
			"ADFRC_AMCU_Soldier_Crewman",
			"ADFRC_AMCU_Soldier_CavalryMan",
			"ADFRC_AMCU_Soldier_GSMG",
			"ADFRC_AMCU_Soldier_GSMGAsst",
			"ADFRC_AMCU_Soldier_AmmoBearer"
		};
		weapons[]={
			"ADFRC_Uniform_AMCU",
...
class CfgEditorSubcategories{
	class ADFRC_MD_Infantry_RAR_AMCU{
		displayName = "Infantry (RAR - AMCU)";
	};
};
	...
	class West{
		...
		class ADF_Present{
			...
			class Motorized{
				...
				class ADFRC_MotInf_Reinforcements_AMCU{
...
class CfgVehicles{
	...
	class ADFRC_AMCU_Soldier_Tee_Base: ADFRC_AMCU_Soldier_Base{
	...
	class ADFRC_AMCU_Soldier_LMG: ADFRC_AMCU_Soldier_Rolled_Base{ // Rolled Sleeves
	...
	class ADFRC_AMCU_Soldier_CavalryScout: ADFRC_AMCU_Soldier_F{
...
class CfgWeapons{
	...
	class ADFRC_Uniform_AMCU_Tee: ADFRC_uniform_dpcu{
		displayName="AMCU Combat Dress (Tee)";
		author="$STR_ADF_AUTHOR";
		scope=2;
		scopeCurator=2;
		picture="";
		...
		class ItemInfo: UniformItem{
			uniformModel="-";
			uniformClass="ADFRC_AMCU_Soldier_Tee_Base";
			containerClass="Supply40";
			mass=40;
		};
	};
